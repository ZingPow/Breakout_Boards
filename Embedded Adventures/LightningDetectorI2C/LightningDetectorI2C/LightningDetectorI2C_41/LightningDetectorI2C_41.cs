...
{
    /// <summary>
    ///     A LightningDetectorI2C module for Microsoft .NET Gadgeteer
    /// </summary>
    public class LightningDetectorI2C : Module
    {
        ...
        /// </summary>
        /// <param name="sender">The <see cref="LightningDetectorI2C" /> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="LightningDetectorI2C" /></param>
        public delegate void ButtonEventHandler(LightningDetectorI2C sender, ButtonState state);

        /// <summary>
        ///     Represents the state of button of the <see cref="LightningDetectorI2C" />.
        /// </summary>
        ...
        // GTM.EmbeddedAdventures.LightningDetectorI2C. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the LightningDetectorI2C module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public LightningDetectorI2C(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        ///     Gets a value that indicates whether the button of the LightningDetectorI2C is pressed.
        /// </summary>
        ...
        /// <summary>
        ///     Raised when the button of the <see cref="LightningDetectorI2C" /> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        ///     Raised when the button of the <see cref="LightningDetectorI2C" /> is released.
        /// </summary>
        /// <remarks>
