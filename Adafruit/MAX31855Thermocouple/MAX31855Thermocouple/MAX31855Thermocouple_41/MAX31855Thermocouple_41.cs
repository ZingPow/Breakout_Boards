...
{
    /// <summary>
    ///     A MAX31855Thermocouple module for Microsoft .NET Gadgeteer
    /// </summary>
    public class MAX31855Thermocouple : Module
    {
        ...
        /// </summary>
        /// <param name="sender">The <see cref="MAX31855Thermocouple" /> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="MAX31855Thermocouple" /></param>
        public delegate void ButtonEventHandler(MAX31855Thermocouple sender, ButtonState state);

        /// <summary>
        ///     Represents the state of button of the <see cref="MAX31855Thermocouple" />.
        /// </summary>
        ...
        // GTM.Adafruit.MAX31855Thermocouple. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the MAX31855Thermocouple module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public MAX31855Thermocouple(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        ///     Gets a value that indicates whether the button of the MAX31855Thermocouple is pressed.
        /// </summary>
        ...
        /// <summary>
        ///     Raised when the button of the <see cref="MAX31855Thermocouple" /> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        ///     Raised when the button of the <see cref="MAX31855Thermocouple" /> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="MAX31855Thermocouple" /> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(MAX31855Thermocouple sender, ButtonState buttonState)
        {
            if (onButton == null)
            {
